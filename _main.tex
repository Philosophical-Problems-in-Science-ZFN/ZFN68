...
\usepackage[width=151mm,height=211mm,center,noinfo]{crop} % konsultuj z dokumentacją
...
{	\setcounter{footnote}{0}%
	...
	\begin{refsection}%
		\pasekpl%
	\begin{raggedleft}%
		{\flushright\chaptitle\color{black!70}{#2\label{\tocnr}\par}}%
		\vspace{7mm}%
		{#9}%
		\vspace{5mm}%
		\selectlanguage{english} %
...
\input{ART_Dada_Piech/Dada-PU.tex}

\input{ART_Krzanowski/Krzanowski-PU.tex}

\input{ART_Piechowicz/Piechowicz-PU.tex}
...
\input{ART_Tambor_Szydlowski/Tambor_Szydlowski-PU.tex}

\input{ART_Liana/Liana-PU.tex}

\input{ART_Mscislawski/Mscislaswki-PU.tex}
